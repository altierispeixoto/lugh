...
```
/lugh:new-ds-project  →  /lugh:spec  →  /lugh:data-profile  →  /lugh:experiment  →  /lugh:model-card  →  /lugh:ml-api
     scaffold              plan            understand data         model & iterate       document              deploy
```
